(function () {
  ...
  var a = {
    ...
    computed: {
      ...
      fields: function () {
        return {
          ...
          imgclass: {
            label: this.$t("editor.blocks.srcset.imgclass.label"),
            type: "text",
            icon: "code",
          },
          link: {
    ...
    methods: {
      fetchOptions: function (t) {
        var e = this;
        this.$api.get(t).then(function (t) {
          e.$nextTick(function () {
            e.options = t;
          });
        });
      ...
      caption: function (t) {
        this.input({ caption: t });
      },
      edit: function () {
        this.attrs.guid && this.$router.push(this.attrs.guid);
      },
      focus: function () {
        this.$refs.element.focus();
      },
      input: function (t) {
        this.$emit("input", { attrs: c({}, this.attrs, {}, t) });
      },
      fetchFile: function (t) {
        var e = this;
        this.$api.get(t).then(function (t) {
          e.input({
            guid: t.link,
            src: t.url,
            id: t.id,
            ratio: t.dimensions.ratio,
          });
        });
      },
      insertFile: function (t) {
        var e = t[0];
        this.fetchFile(e.link);
      },
      insertUpload: function (t, e) {
        this.fetchFile(e[0].link);
      },
      menu: function () {
      ...
      onLoad: function () {
        ...
        !this.attrs.ratio &&
          ...
          t.width &&
          t.height &&
          this.input({ ratio: t.width / t.height });
      },
      replace: function () {
      ...
      saveSettings: function () {
        this.$refs.settings.close(), this.input(this.attrs);
      },
      uploadFile: function () {
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.$t("editor.blocks.srcset.icon")) +
                                  " "
                              ),
                            ]
                          ),
                        ...
                        [
                          _c("k-editable", {
                            attrs: {
                              ...
                              placeholder:
                                _vm.$t(
                                  "editor.blocks.srcset.caption.placeholder"
                                ) + "\u2026",
                            },
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.$t("editor.blocks.srcset.upload")) +
                                  " "
                              ),
                            ]
                          ),
                          ...
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.$t("editor.blocks.srcset.select")) +
                                  " "
                              ),
                            ]
                          ),
  ...
  panel.plugins.fields.editor && editor.block("srcset", a);
})();
