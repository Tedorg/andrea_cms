...
final class SrcsetTest extends TestCase
{
    ...
    public function testNonce()
    {
        ...
        $this->assertRegExp('/^<srcsetplugin>\n\n<style>/', $srcset->html());
        $srcset = new Srcset([
            "value" => "test2000.png",
            "parent" => page("home"),
            "nonce" => "@NONCE@",
    ...
    public function testImageFromData()
    {
        ...
        $this->assertNotRegExp("/data-src/", $srcset->html());
    ...
    public function testSrcsetTag()
    {
        ...
        $textFromTag = kirby()->kirbytags(
            "(lazysrcset: test2000.png sizes: default imgclass: c-image ratio: custom-class)",
            $this->data
        );
        ...
        $text = $srcset->html();
        $textFromTag = kirby()->kirbytags(
            "(lazysrcset: test2000.png sizes: default figure: true lazy: false ratio: false autosizes: prefix: )",
            $this->data
        );
        $this->assertEquals($text, $textFromTag);
        ...
        $text = $srcset->html();
        $textFromTag = kirby()->kirbytags(
            "(lazysrcset: test2000.png sizes: default figure: true lazy: false ratio: lazysrcset-ratio autosizes: prefix: caption: some caption)",
            $this->data
        );
        $this->assertEquals($text, $textFromTag);
    }
