...
var HorizontalScroll = /** @class */ (function (_super) {
    ...
    function HorizontalScroll(_a) {
        ...
        _this.wheel = function (e) {
          //  (passiveSupported && (active || e == window.document || e == window.document.body || e == window)) ? e.addEventListener(name, fn, { passive: false, capture: bubble }) : e.addEventListener(name, fn, bubble || false);
